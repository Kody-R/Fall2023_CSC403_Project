...
namespace Fall2020_CSC403_Project
{
    public partial class FrmBattle : Form
    {
        ...
        private void playerDeath()
        {
            ...
            death.Play();
            */
            //MessageBox.Show("You died.", "Close", "Restart" MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxIcon.Information);
        ...
        private void enemyDeath(Enemy enemy)
        {
            ...
            enemy.Img = (Image)Properties.Resources.ResourceManager.GetObject("DeadEnemy");
        }
